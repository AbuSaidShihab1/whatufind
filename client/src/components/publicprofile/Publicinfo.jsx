...
import Publicachieve from "./Publicachieve";
const Publicinfo = () => {
            ...
            <div className="skill-contentmain">
              ...
              <div className="skillcontent-box">
                ...
                <div className="skill-contentinfo-main">
                  <div className="skill-contentinfo">
                    <img
                      src="https://t4.ftcdn.net/jpg/01/09/39/37/360_F_109393752_7ndfitmYEy57uF8w4lePaQiyRZ5SOfKL.jpg"
                      alt=""
                    />
                    <div className="skillinfo-text">
                      <p>Auditor at Intertek Bangladesh</p>
                  ...
                  <div className="skill-contentinfo">
                    <img
                      src="https://previews.123rf.com/images/stodolskaya/stodolskaya1708/stodolskaya170800041/84143751-magnifying-glass-used-for-auditing.jpg"
                      alt=""
                    />
                    <div className="skillinfo-text">
                      <p>Auditor at Intertek Bangladesh</p>
                  ...
                  <div className="skill-contentinfo">
                    <img
                      src="https://media.istockphoto.com/id/614404920/it/vettoriale/illustrazione-vettoriale-di-audit-contabilit%C3%A0-e-analisi-finanziaria.jpg?s=1024x1024&w=is&k=20&c=AZ0NxtFn4PFjxHhZuk5uf60uDgsTLL4b-YHaicx7Riw="
                      alt=""
                    />
                    <div className="skillinfo-text">
                      <p>Auditor at Intertek Bangladesh</p>
